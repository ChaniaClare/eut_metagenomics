...
KNEADDATA_DB="/Users/chaniaclare/Library/CloudStorage/OneDrive-UniversityCollegeLondon/Documents/PhD/Barnes-PhD/metagenomics/projects/eut_metagenomics/kneaddata_database/bowtie2-index"
...
for sample in "${ALL_SAMPLES[@]}"; do
    ...
    if [ -f "${KNEADDATA_DIR}/${sample}/${sample}_kneaddata_paired_1.fastq" ] && [ -f "${KNEADDATA_DIR}/${sample}/${sample}_kneaddata_paired_2.fastq" ]; then
    ...
    gzip ${KNEADDATA_DIR}/${sample}/*.fastq
